...
module.exports = {
  ...
  confirmHCP: function (browser) {
    browser
      ...
      .click(confirm)
      .pause(2000)
      .waitForElementVisible(productView, 2000, 'Product view show up?')
  },
